...
# python lstm.py --epochs 12  --lstm_dropout 0.3
...
rnn = RNN(mlp_output_size, args.hidden_size, lstm_output_size, args.lstm_layers, args.batch_size).to(device)
...
def train_model():
    ...
    for (x_train, y_train) in train_dataloader:
        ...
        rnn_output = rnn(mlp_output.unsqueeze(0))
